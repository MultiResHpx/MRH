...
template<typename I> class T_Healpix_Base: public Healpix_Tables
  ...
  protected:
    ...
    I xyf2nest(int ix, int iy, int fn) const;
    void nest2xyf(I pix, int &ix, int &iy, int &fn) const;
    I xyf2ring(int ix, int iy, int fn) const;
    void ring2xyf(I pix, int &ix, int &iy, int &fn) const;
  ...
  public:
    ...
    I xyf2pix(int ix, int iy, int fn) const
      {
      return (scheme_==RING) ?
        xyf2ring(ix,iy,fn) : xyf2nest(ix,iy,fn);
      }
    void pix2xyf(I pix, int &ix, int &iy, int &fn) const
      {
      (scheme_==RING) ?
...
typedef T_Healpix_Base<int64> Healpix_Base;
